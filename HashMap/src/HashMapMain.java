public class HashMapMain {
    public static void main (String[] args){
        ...
        1. Create a HashMap called "inventory" that contains each of these items and their values.
    Hint 1.
    ...
    Hint 4:
            ...
            .... which means making a new HashMap.

        5. Log the contents of your inventory (and backpack if you have one)
    Hint 5:

        6. Display the Size of your inventory(& backpack).
    Hint 6:
        */
